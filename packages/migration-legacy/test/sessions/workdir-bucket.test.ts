...
/**
 * Reference re-implementation of eddy-core `encodeWorkDirKey` +
 * `slugifyWorkDirName` (packages/eddy-core/src/harness/session-manager/
 * workdir-key.ts + utils/workdir-slug.ts). Kept inline because those
 * functions are not part of eddy-core's public export surface. The migrator's
...
describe('computeWorkdirBucket matches eddy-core encodeWorkDirKey', () => {
  it.each([
    '/Users/example/proj',
