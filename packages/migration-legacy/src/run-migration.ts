...
const CONFIG_CONFLICT_NOTICE =
  'Your existing config.toml could not be parsed; migrated copy saved to ~/.eddy-code/config.migrated-from-eddy-code.toml — please review and merge manually.';

const TUI_CONFLICT_NOTICE =
  'Your existing tui.toml had user modifications; migrated copy saved to ~/.eddy-code/tui.migrated-from-eddy-code.toml — please review and merge manually.';
