 ...
 * `packages/eddy-core/src/utils/workdir-slug.ts` and
 * `packages/eddy-core/src/harness/session-manager/workdir-key.ts:13–18`.
 *
 ...
 * `@eddy-code/agent-core` (file: `src/utils/workdir-slug.ts`). It is not part
...
/**
 * Local copy of eddy-core's `slugifyWorkDirName`. Keep byte-identical to the
 * canonical implementation in `packages/eddy-core/src/utils/workdir-slug.ts`.
 */
