...
/**
 * Copy the user's legacy skills tree (~/.eddy-code/skills/) into eddy-code's
 * default user skills root (~/.eddy-code/skills/). Granularity is one
...
export async function migrateSkillsStep(input: SkillsStepInput): Promise<SkillsStepResult> {
  ...
  for (const name of entries) {
    ...
    // in it — touching it earlier would fail when ~/.eddy-code/skills is
