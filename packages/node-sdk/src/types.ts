...
import type { EddyHostIdentity } from '@eddy-code/config';
...
export type { EddyHostIdentity } from '@eddy-code/config';
export type { ContentPart, Role, ToolCall } from '@eddy-code/ltod';
...
export interface EddyHarnessOptions {
