...
import { EddyHarness, type EddyError, type PermissionMode } from '#/index';
...
describe('Session.setPermission', () => {
  it.each(['yolo', 'manual', 'auto'] as const)(
    ...
    async (mode: PermissionMode) => {
      const homeDir = await makeTempDir(tempDirs, 'eddy-sdk-permission-home-');
      const workDir = await makeTempDir(tempDirs, 'eddy-sdk-permission-work-');
