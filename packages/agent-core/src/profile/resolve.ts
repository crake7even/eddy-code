 ...
 * (EDDY_OS, EDDY_AGENTS_MD, ...) at render time.
 */
...
function buildTemplateVars(
  ...
  return {
    ...promptVars,
    EDDY_OS: context.osEnv.osKind,
    EDDY_SHELL: `${context.osEnv.shellName} (\`${context.osEnv.shellPath}\`)`,
    EDDY_NOW: now,
    EDDY_WORK_DIR: context.cwd,
    EDDY_WORK_DIR_LS: context.cwdListing ?? '',
    EDDY_AGENTS_MD: context.agentsMd ?? '',
    EDDY_SKILLS: skills,
    EDDY_ADDITIONAL_DIRS_INFO: context.additionalDirsInfo ?? '',
    ROLE_ADDITIONAL:
