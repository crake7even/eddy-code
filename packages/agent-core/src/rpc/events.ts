import type { FinishReason, TokenUsage } from '@eddy-code/ltod';

import type { PromptOrigin } from '../agent/context';
import type { GoalChange, GoalSnapshot } from '../agent/goal';
import type { EddyErrorPayload } from '../errors';
...
export type { EddyErrorPayload } from '../errors';
...
export interface ErrorEvent extends EddyErrorPayload {
  readonly type: 'error';
}
...
export interface TurnEndedEvent {
  ...
  readonly error?: EddyErrorPayload | undefined;
}
