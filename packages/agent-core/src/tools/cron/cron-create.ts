 ...
 * `eddy resume` of the same session reloads them and the scheduler
...
// 鈹€鈹€ Constants 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
 ...
 * schema limit is in code units, which underflows multi-byte input
 * (`'姹?.length === 1` even though it is 3 bytes); we re-check using
 ...
 * reminder 鈥?if submission lands seconds past the target minute,
 ...
 * days is tight enough to catch the rollover (365 卤 epsilon) while
...
// 鈹€鈹€ Input schema 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
// 鈹€鈹€ Output shape (internal) 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
// 鈹€鈹€ Implementation 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
export class CronCreateTool implements BuiltinTool<CronCreateInput> {
  ...
  resolveExecution(args: CronCreateInput): ToolExecution {
    // 1. Global killswitch 鈥?checked first so a flipped env stops all
    //    further work, including the cron parse which can throw on
    //    legitimately-malformed input.
    if (process.env['EDDY_DISABLE_CRON'] === '1') {
      return {
        isError: true,
        output: 'Cron scheduling is disabled (EDDY_DISABLE_CRON=1).',
      };
    }
    ...
    //    verbatim 鈥?the parser is already careful to name the
    //    offending field.
    ...
    // 4. Reject "legal but never fires within 5 years" 鈥?the same
    ...
    // 5. Session-level cap 鈥?preliminary check. We re-check inside
    ...
    // `recurring` is defaulted before tool execution; we re-derive the
    ...
    //    ~one year out 鈥?for a 5-field cron this can only mean the
      ...
      if (
        ...
        return {
          ...
          output: `One-shot cron ${JSON.stringify(
            ...
            firstFire,
          ).toISOString()} (more than a year out). If you meant "today" or a near date, the pinned day/month has already passed this year 鈥?pick a future date or use wildcards.`,
        };
      }
    }
    ...
    return {
      ...
      // session 鈥?including ones the user never saw before approving.
      ...
      execute: async () => {
        ...
        // already rejected that above, but be defensive 鈥?the jitter
