...
describe('Agent compaction', () => {
  ...
  it('does not split inside a parallel tool exchange', () => {
    ...
    // never between tool_a and tool_b 鈥?that would leave tool_b as an orphan.
    expect(strategy.computeCompactCount(messages, 'auto')).toBe(2);
  });
  ...
  it('runs manual compaction and applies the compacted context', async () => {
    ...
    expect(ctx.newEvents()).toMatchInlineSnapshot(`
      ...
      [wire] usage.record               { "model": "eddy-code", "usage": { "inputOther": 879, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 }, "usageScope": "session", "time": "<time>" }
      [emit] agent.status.updated       { "model": "eddy-code", "contextTokens": 120, "maxContextTokens": 256000, "contextUsage": 0.00046875, "planMode": false, "permission": "manual", "usage": { "byModel": { "eddy-code": { "inputOther": 879, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 879, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
      ...
      [emit] agent.status.updated       { "model": "eddy-code", "contextTokens": 5, "maxContextTokens": 256000, "contextUsage": 0.00001953125, "planMode": false, "permission": "manual", "usage": { "byModel": { "eddy-code": { "inputOther": 879, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 879, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
    `);
  ...
  it('force-refreshes OAuth credentials on compaction 401 and falls back to login_required when replay 401', async () => {
    ...
    ctx.configure();
    await ctx.rpc.setModel({ model: 'eddy-code' });
    ctx.newEvents();
    ctx.appendExchange(1, 'old user one', 'old assistant one', 20);
  ...
  it('fires PreCompact and PostCompact hooks from the compaction module', async () => {
    const dir = mkdtempSync(join(tmpdir(), 'eddy-compact-hooks-'));
  ...
  it('keeps messages appended while compacting an unchanged prefix', async () => {
    ...
    expect(ctx.newEvents()).toMatchInlineSnapshot(`
      ...
      [wire] usage.record               { "model": "eddy-code", "usage": { "inputOther": 857, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 }, "usageScope": "session", "time": "<time>" }
      [emit] agent.status.updated       { "model": "eddy-code", "contextTokens": 80, "maxContextTokens": 256000, "contextUsage": 0.0003125, "planMode": false, "permission": "manual", "usage": { "byModel": { "eddy-code": { "inputOther": 857, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 857, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
      [wire] full_compaction.complete   { "time": "<time>" }
      ...
      [emit] agent.status.updated       { "model": "eddy-code", "contextTokens": 5, "maxContextTokens": 256000, "contextUsage": 0.00001953125, "planMode": false, "permission": "manual", "usage": { "byModel": { "eddy-code": { "inputOther": 857, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 857, "output": 8, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
    `);
    expect(ctx.lastLlmInput()).toMatchInlineSnapshot(`
      system: "You are a conversation context compaction assistant. Your job is to summarize the conversation above into a structured summary. Output text only. DO NOT CALL ANY TOOLS. Follow the compaction instruction in the last user message exactly. Pay special attention to the Memory Memo Extraction section 鈥?you MUST output memory-memo blocks for every completed task loop."
      tools: []
  ...
  it('cancels when the compacted prefix changes before completion', async () => {
    ...
    expect(ctx.newEvents()).toMatchInlineSnapshot(`
      ...
      [emit] agent.status.updated     { "model": "eddy-code", "contextTokens": 0, "maxContextTokens": 256000, "contextUsage": 0, "planMode": false, "permission": "manual" }
  ...
  it('blocks the turn until auto compaction finishes', async () => {
    ...
    expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
      ...
      [wire] usage.record                { "model": "eddy-code", "usage": { "inputOther": 856, "output": 9, "inputCacheRead": 0, "inputCacheCreation": 0 }, "usageScope": "session", "time": "<time>" }
      [emit] agent.status.updated        { "model": "eddy-code", "contextTokens": 950000, "maxContextTokens": 256000, "contextUsage": 3.7109375, "planMode": false, "permission": "manual", "usage": { "byModel": { "eddy-code": { "inputOther": 856, "output": 9, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 856, "output": 9, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
      [wire] full_compaction.complete    { "time": "<time>" }
      ...
      [emit] agent.status.updated        { "model": "eddy-code", "contextTokens": 28, "maxContextTokens": 256000, "contextUsage": 0.000109375, "planMode": false, "permission": "manual", "usage": { "byModel": { "eddy-code": { "inputOther": 856, "output": 9, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 856, "output": 9, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
      ...
      [wire] usage.record                { "model": "eddy-code", "usage": { "inputOther": 31, "output": 11, "inputCacheRead": 0, "inputCacheCreation": 0 }, "usageScope": "turn", "time": "<time>" }
      [emit] agent.status.updated        { "model": "eddy-code", "contextTokens": 42, "maxContextTokens": 256000, "contextUsage": 0.0001640625, "planMode": false, "permission": "manual", "usage": { "byModel": { "eddy-code": { "inputOther": 887, "output": 20, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 887, "output": 20, "inputCacheRead": 0, "inputCacheCreation": 0 }, "currentTurn": { "inputOther": 31, "output": 11, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
  ...
  it('keeps a deferred system reminder behind an unresolved tool exchange across compaction', async () => {
    ...
    // Tool exchange is open, so the reminder is deferred 鈥?not yet in history.
  ...
  it('keeps a deferred system reminder behind a partially resolved tool exchange across compaction', async () => {
    ...
    // One tool result has landed but the second is still pending 鈥?reminder defers.
    expect(ctx.agent.context.history.map((m) => m.role)).toEqual([
      'user',
      'assistant',
      'user',
  ...
  it('emits context.overflow and terminates the turn after too many auto compactions', async () => {
    ...
    expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
      ...
      [emit] turn.ended                  { "turnId": 0, "reason": "failed", "error": { "code": "context.overflow", "message": "Compaction limit exceeded (1)", "name": "EddyError", "details": { "maxCompactions": 1, "turnId": 0 }, "retryable": true } }
    `);
    expect(ctx.newEvents()).toMatchInlineSnapshot(
      `[emit] error   { "code": "context.overflow", "message": "Compaction limit exceeded (1)", "name": "EddyError", "details": { "maxCompactions": 1, "turnId": 0 }, "retryable": true }`,
    );
    expect(ctx.llmInputs()).toMatchInlineSnapshot(`
      call 1:
        system: "You are a conversation context compaction assistant. Your job is to summarize the conversation above into a structured summary. Output text only. DO NOT CALL ANY TOOLS. Follow the compaction instruction in the last user message exactly. Pay special attention to the Memory Memo Extraction section 鈥?you MUST output memory-memo blocks for every completed task loop."
...
function oauthTestAgentOptions(
  ...
  return {
    initialConfig: {
      defaultModel: 'eddy-code',
      providers: {
        'managed:eddy-code': {
          type: 'vertexai',
          baseUrl: 'https://api.example/v1',
          oauth: { storage: 'file', key: 'oauth/eddy-code' },
        },
      },
      models: {
        'eddy-code': {
