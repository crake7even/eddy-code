...
import { EddyCliFetchURLProvider } from '../../../src/tools/providers/eddy-cli-fetch-url';
...
describe('EddyCliFetchURLProvider auth fallback', () => {
  it('falls back to the configured API key when the token provider has no token', async () => {
    ...
    // the host should call eddy-code with the static api key when oauth
    ...
    const provider = new EddyCliFetchURLProvider({
...
describe('EddyCliFetchURLProvider content kind', () => {
...
describe('EddyCliFetchURLProvider caching', () => {
