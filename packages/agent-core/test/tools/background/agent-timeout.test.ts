...
describe('BackgroundProcessManager.registerAgentTask — timeoutMs', () => {
  ...
  // eddy-code do NOT carry an implicit default timeout. The Python
  // eddy-code enforced a 30-min default because its agents were
  // expected to be short-lived; eddy-code's agents may legitimately
  ...
  // Contract decision (2026-05-21): eddy-code treats `timeoutMs: 0`
