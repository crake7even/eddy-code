...
export function createProgram(
  ...
  // Hidden subcommand for cc-connect / compatible stream-json protocol.
  // cc-connect spawns: eddy stream-json --output-format stream-json --input-format stream-json
  ...
  //   --system-prompt, --allowedTools, --disallowedTools, --effort, --max-context-tokens.
  program
    ...
    .option('--append-system-prompt-file <path>', '(passed through to agent)')
  ...
  // `eddy channel setup` — interactive cc-connect platform configuration wizard.
