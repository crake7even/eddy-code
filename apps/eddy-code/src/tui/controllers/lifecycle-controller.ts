import type { Session, EddyHarness } from '@eddy-code/sdk';
...
import { createEddyTUIThemeBundle } from '../theme/bundle';
import type { ResolvedTheme } from '../theme/colors';
import type { Theme } from '../theme/index';
import type { AppState, EddyTUIOptions } from '../types';
...
export class LifecycleController {
  ...
  applyTheme(theme: Theme, resolved?: ResolvedTheme): void {
    const nextTheme = createEddyTUIThemeBundle(theme, resolved);
