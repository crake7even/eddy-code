...
export interface EddyTUIStartupInput {
...
function createInitialAppState(input: EddyTUIStartupInput): AppState {
...
export class EddyTUI implements TranscriptControllerHost, LifecycleControllerHost, InputControllerHost {
  readonly harness: EddyHarness;
  readonly options: EddyTUIOptions;
  session: Session | undefined;
  state: TUIState;
  readonly approvalController = new ApprovalController();
  readonly questionController = new QuestionController();
  private skillCommands: readonly EddySlashCommand[] = [];
  ...
  constructor(harness: EddyHarness, startupInput: EddyTUIStartupInput) {
    this.harness = harness;
    const tuiOptions: EddyTUIOptions = {
  ...
  getSlashCommands(): readonly EddySlashCommand[] {
