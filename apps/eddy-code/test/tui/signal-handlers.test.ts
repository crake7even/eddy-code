...
import { EddyTUI, type EddyTUIStartupInput } from '#/tui/eddy-tui';
...
function makeStartupInput(): EddyTUIStartupInput {
  return {
    cliOptions: {
      session: undefined,
      continue: false,
...
function makeDriver(): { driver: SignalDriver; tui: EddyTUI } {
  const tui = new EddyTUI(makeHarness() as never, makeStartupInput());
...
describe('EddyTUI signal handlers', () => {
