...
describe('ChoicePickerComponent', () => {
  ...
  it('submits the selected model and inline thinking state', () => {
    ...
    expect(onSelect).toHaveBeenCalledWith({ alias: 'eddy', thinking: false });
  });
